...
LINUX_PWM_SRC = $(wildcard $(LINUX_PWM_PATH)/*.c)
LINUX_PWM_OBJ = $(patsubst %.c, %.o, $(LINUX_PWM_SRC))

# 所有目标文件的集合(根据项目情况修改)
TARGET_OBJS := $(TOP_OBJ) $(LINUX_PWM_OBJ)
